  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white font-sans px-6 py-8">
      <header className="flex justify-between items-center mb-10 max-w-6xl mx-auto">
        <h1 className="text-2xl font-extrabold">Transact Shack</h1>
        <nav className="space-x-4 text-sm">
          ...
          <a href="/devops-assistant" className="hover:underline">Transact Assistant</a>
        </nav>
      </header>
      ...
      <footer className="mt-16 text-center text-sm text-gray-400">
        © 2025 GenAI Assistant · <span className="text-purple-400 font-semibold">Transact Shack</span>
      </footer>
    </div>
  );
}
